; This API is distributed under the GNU LGPL v3
; It can be found at https://github.com/SAMPProjects/Open-SAMP-API


#NoEnv 

PATH_SAMP_API := "Open-SAMP-API.dll"

hModule := DllCall("LoadLibrary", Str, PATH_SAMP_API)
if(hModule == -1 || hModule == 0)
{
	MsgBox, 48, Error, The dll-file couldn't be found!`nTrying alternate path.	
}
